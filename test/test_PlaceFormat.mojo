...
def test_PlaceFormat_1():
    ...
    assert_equal(place.map[0, 0][0], Block("A", 0, Blocktype.NONE))
    assert_equal(place.map[0, 1][0], Block("B", 0, Blocktype.NONE))
    assert_equal(place.map[1, 0][0], Block("C", 0, Blocktype.NONE))
    assert_equal(place.map[1, 1][0], Block("D", 0, Blocktype.NONE))
